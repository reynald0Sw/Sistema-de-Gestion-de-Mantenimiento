...
export function Equipment() {
  ...
  const operationalEquipment = equipment.filter((eq) => eq.status === 'operativo').length;
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-3xl mt-2 text-green-600">{operationalEquipment}</div>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-3xl mt-2 text-blue-600">{avgAvailability}%</div>
              </div>
          ...
          <Card key={eq.id} className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="border-t pt-3">
                ...
                <p className="text-sm">
                  {new Date(eq.nextMaintenance).toLocaleDateString('es-ES')}
                </p>
              </div>
